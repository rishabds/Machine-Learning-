...
###_Main_###
def main():
    items = ReadData('C:\\Users\\Rishab Dussoye\\Desktop\\Diploma in IT - (IoT)\\Semester 1\\Programming with Python\\Lecture Notes - Machine Learning - Linear Regression\\fileKMeans.txt')
    ...
    plt.scatter(X[:, 0], X[:, 1], s=20, c=y_kmeans, cmap='autumn');
    centers = kmeans.cluster_centers_
    plt.scatter(centers[:, 0], centers[:, 1], c='black', s=20, alpha=0.9);
    plt.show()
